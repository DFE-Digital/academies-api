...
namespace TramsDataApi.Test.Factories
{
    public class A2BApplyingSchoolFactoryTests
    {
        ...
        {
            var response = A2BApplyingSchoolFactory.Create(null);

            response.Should().BeNull();
        }

        [Fact]
        public void Create_ReturnsExpectedA2BApplyingSchool_WhenA2BApplyingSchoolRequestIsProvided()
        {
            var request = Builder<A2BApplyingSchoolCreateRequest>
                .CreateNew()
                .Build();

            var expectedStatus = new A2BApplyingSchool
            {
            ...
            var response = A2BApplyingSchoolFactory.Create(request);
