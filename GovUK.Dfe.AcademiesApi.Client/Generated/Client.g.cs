...
namespace GovUK.Dfe.AcademiesApi.Client
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <returns>Successfully found and returned the diocese.</returns>
        /// <exception cref="AcademiesApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<NameAndCodeDto> GetDioceseByCodeAsync(string code)
        {
            return GetDioceseByCodeAsync(code, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Successfully found and returned the diocese.</returns>
        /// <exception cref="AcademiesApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<NameAndCodeDto> GetDioceseByCodeAsync(string code, System.Threading.CancellationToken cancellationToken)
        {
            if (code == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v4/diocese/{code}"
                    urlBuilder_.Append("v4/diocese/");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<NameAndCodeDto>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new AcademiesApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
                            throw new AcademiesApiException("Diocese with specified name code not found.", status_, responseText_, headers_, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
        ...
        {
            return SearchDiocesesAsync(name, code, System.Threading.CancellationToken.None);
        }
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.ObjectModel.ObservableCollection<NameAndCodeDto>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new AcademiesApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <returns>Successfully found and returned the establishments.</returns>
        /// <exception cref="AcademiesApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<EstablishmentDto>> GetByTrustReferenceNumberAsync(string? trustReferenceNumber)
        {
            return GetByTrustReferenceNumberAsync(trustReferenceNumber, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Successfully found and returned the establishments.</returns>
        /// <exception cref="AcademiesApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<EstablishmentDto>> GetByTrustReferenceNumberAsync(string? trustReferenceNumber, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v4/establishments/trustReferenceNumber"
                    urlBuilder_.Append("v4/establishments/trustReferenceNumber");
                    urlBuilder_.Append('?');
                    if (trustReferenceNumber != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("trustReferenceNumber")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(trustReferenceNumber, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    }
                    urlBuilder_.Length--;
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
                            throw new AcademiesApiException("Establishments with specified TRN not found.", status_, responseText_, headers_, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class LocalAuthorityV4Client : ILocalAuthorityV4Client
    {
        #pragma warning disable 8618
        private string _baseUrl;
        #pragma warning restore 8618
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public LocalAuthorityV4Client(string baseUrl, System.Net.Http.HttpClient httpClient)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        {
            BaseUrl = baseUrl;
            _httpClient = httpClient;
        ...
        public virtual async System.Threading.Tasks.Task<NameAndCodeDto> GetLocalAuthorityByCodeAsync(string code, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v4/local-authorities/{code}"
                    urlBuilder_.Append("v4/local-authorities/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(code, System.Globalization.CultureInfo.InvariantCulture)));
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
                            throw new AcademiesApiException("local authority with specified name code not found.", status_, responseText_, headers_, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="AcademiesApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<NameAndCodeDto>> SearchLocalAuthoritiesAsync(string? name, string? code)
        {
            return SearchLocalAuthoritiesAsync(name, code, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Successfully executed the search and returned local Authorities.</returns>
        /// <exception cref="AcademiesApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<NameAndCodeDto>> SearchLocalAuthoritiesAsync(string? name, string? code, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v4/local-authorities"
                    urlBuilder_.Append("v4/local-authorities");
                    urlBuilder_.Append('?');
                    if (name != null)
                    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SignificantChangesV4Client : ISignificantChangesV4Client
    {
        #pragma warning disable 8618
        private string _baseUrl;
        #pragma warning restore 8618
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public SignificantChangesV4Client(string baseUrl, System.Net.Http.HttpClient httpClient)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        {
            BaseUrl = baseUrl;
            _httpClient = httpClient;
        ...
        public virtual async System.Threading.Tasks.Task<PagedDataResponseOfSignificantChangeDto> SearchSignificantChangesAsync(string? deliveryOfficer, bool? orderByChangeEditDate, bool? isDescending, int? page, int? count, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v4/significantchanges"
                    urlBuilder_.Append("v4/significantchanges");
                    urlBuilder_.Append('?');
                    if (deliveryOfficer != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("deliveryOfficer")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(deliveryOfficer, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    }
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<PagedDataResponseOfSignificantChangeDto>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new AcademiesApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <returns>Successfully retrieved the trusts.</returns>
        /// <exception cref="AcademiesApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<TrustDto>> GetByTrnsAsync(System.Collections.Generic.IEnumerable<string>? trns)
        {
            return GetByTrnsAsync(trns, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Successfully retrieved the trusts.</returns>
        /// <exception cref="AcademiesApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<TrustDto>> GetByTrnsAsync(System.Collections.Generic.IEnumerable<string>? trns, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v4/trusts/trustReferenceNumber/bulk"
                    urlBuilder_.Append("v4/trusts/trustReferenceNumber/bulk");
                    urlBuilder_.Append('?');
                    if (trns != null)
                    {
                            foreach (var item_ in trns) { urlBuilder_.Append(System.Uri.EscapeDataString("trns")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(item_, System.Globalization.CultureInfo.InvariantCulture))).Append('&'); }
                    }
                    urlBuilder_.Length--;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class EstablishmentsV5Client : IEstablishmentsV5Client
    {
        #pragma warning disable 8618
        private string _baseUrl;
        #pragma warning restore 8618
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public EstablishmentsV5Client(string baseUrl, System.Net.Http.HttpClient httpClient)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        {
            BaseUrl = baseUrl;
            _httpClient = httpClient;
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<EstablishmentDto2>> SearchEstablishmentsWithOfstedReportCardsAsync(string? name, string? ukPrn, string? urn, bool? excludeClosed, bool? matchAny, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v5/establishments"
                    urlBuilder_.Append("v5/establishments");
                    urlBuilder_.Append('?');
                    if (name != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("name")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(name, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.ObjectModel.ObservableCollection<EstablishmentDto2>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new AcademiesApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>Successfully executed the search and returned Establishments.</returns>
        /// <exception cref="AcademiesApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<EstablishmentDto2>> GetEstablishmentsWithOfstedReportCardsByUrnsAsync(UrnRequestModel model)
        {
            return GetEstablishmentsWithOfstedReportCardsByUrnsAsync(model, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Successfully executed the search and returned Establishments.</returns>
        /// <exception cref="AcademiesApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<EstablishmentDto2>> GetEstablishmentsWithOfstedReportCardsByUrnsAsync(UrnRequestModel model, System.Threading.CancellationToken cancellationToken)
        {
            if (model == null)
                throw new System.ArgumentNullException("model");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v5/establishments/bulk/urns"
                    urlBuilder_.Append("v5/establishments/bulk/urns");
