...
namespace Dfe.AcademiesApi.Client
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.2.0.0 (NJsonSchema v11.1.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class DataLakePocV5Client : IDataLakePocV5Client
    {
        #pragma warning disable 8618
        private string _baseUrl;
        #pragma warning restore 8618
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public DataLakePocV5Client(string baseUrl, System.Net.Http.HttpClient httpClient)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        {
            BaseUrl = baseUrl;
            _httpClient = httpClient;
        ...
        /// <exception cref="AcademiesApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<DatabricksQueryResult> ExecuteSqlAsync(DataLakeSqlQueryRequest request)
        {
            return ExecuteSqlAsync(request, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Query completed successfully.</returns>
        /// <exception cref="AcademiesApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<DatabricksQueryResult> ExecuteSqlAsync(DataLakeSqlQueryRequest request, System.Threading.CancellationToken cancellationToken)
        {
            if (request == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v5/datalake/query"
                    urlBuilder_.Append("v5/datalake/query");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<DatabricksQueryResult>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new AcademiesApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new AcademiesApiException("Request validation failed (e.g. empty SQL).", status_, responseText_, headers_, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
