    ...
    public class GetEstablishmentsByTrustUid : IGetEstablishmentsByTrustUid
    {
        ...
        public List<EstablishmentResponse> Execute(string trustUid)
        {
            return _establishmentGateway.GetByTrustUid(trustUid)
                .Select(e =>
                    EstablishmentResponseFactory.Create(e, _establishmentGateway.GetMisEstablishmentByUrn(e.Urn), _establishmentGateway.GetSmartDataByUrn(e.Urn), _establishmentGateway.GetFurtherEducationEstablishmentByUrn(e.Urn), null)
                    )
                .ToList();
        }
    }
