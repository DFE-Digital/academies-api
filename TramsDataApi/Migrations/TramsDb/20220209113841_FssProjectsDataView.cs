...
{
    public partial class FssProjectsDataView : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            _ = migrationBuilder.Sql(@"CREATE VIEW fsg.vw_Fss_ProjectData
                                        AS 
                                    SELECT                                 
        ...
        {
            migrationBuilder.Sql(@"drop view fsg.vw_Fss_ProjectData");
