...
namespace TramsDataApi.Migrations.TramsDb
{
    ...
    [Migration("20221005100254_Add_assigneduser_to_conversionproject")]
    partial class Add_assigneduser_to_conversionproject
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TramsDataApi.DatabaseModels.NoticeToImprove", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("NoticeToImproveCase","sdd");
                });

            modelBuilder.Entity("TramsDataApi.DatabaseModels.NoticeToImproveCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("NoticeToImproveCondition","sdd");
            ...
            modelBuilder.Entity("TramsDataApi.DatabaseModels.NoticeToImproveConditionMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("NoticeToImproveConditionMapping","sdd");
                });

            modelBuilder.Entity("TramsDataApi.DatabaseModels.NoticeToImproveConditionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("NoticeToImproveConditionType","sdd");
            ...
            modelBuilder.Entity("TramsDataApi.DatabaseModels.NoticeToImproveReason", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("NoticeToImproveReason","sdd");
            ...
            modelBuilder.Entity("TramsDataApi.DatabaseModels.NoticeToImproveReasonMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("NoticeToImproveReasonMapping","sdd");
                });

            modelBuilder.Entity("TramsDataApi.DatabaseModels.NoticeToImproveStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("NoticeToImproveStatus","sdd");
            ...
            modelBuilder.Entity("TramsDataApi.DatabaseModels.NoticeToImprove", b =>
                {
                    b.HasOne("TramsDataApi.DatabaseModels.NoticeToImproveStatus", "ClosedStatus")
                        .WithMany()
                        .HasForeignKey("ClosedStatusId");

                    b.HasOne("TramsDataApi.DatabaseModels.NoticeToImproveStatus", "Status")
                        .WithMany()
                        .HasForeignKey("StatusId");
                });
            ...
            modelBuilder.Entity("TramsDataApi.DatabaseModels.NoticeToImproveCondition", b =>
                {
                    b.HasOne("TramsDataApi.DatabaseModels.NoticeToImproveConditionType", "ConditionType")
                        .WithMany()
                        .HasForeignKey("ConditionTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TramsDataApi.DatabaseModels.NoticeToImproveConditionMapping", b =>
                {
                    b.HasOne("TramsDataApi.DatabaseModels.NoticeToImproveCondition", "NoticeToImproveCondition")
                        .WithMany("NoticeToImproveConditionsMapping")
                        .HasForeignKey("NoticeToImproveConditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TramsDataApi.DatabaseModels.NoticeToImprove", "NoticeToImprove")
                        .WithMany("NoticeToImproveConditionsMapping")
            ...
            modelBuilder.Entity("TramsDataApi.DatabaseModels.NoticeToImproveReasonMapping", b =>
                {
                    ...
                    b.HasOne("TramsDataApi.DatabaseModels.NoticeToImproveReason", "NoticeToImproveReason")
                        .WithMany("NoticeToImproveReasonsMapping")
