    ...
    public static class FssProjectResponseFactory
    {
        public static FssProjectResponse Create(FssProject fssProject)
        {
            ...
            return new FssProjectResponse
            {
                ...
                URN = fssProject.URN,
                FAActualDateOfCompletion = fssProject.FAActualDateOfCompletion,
