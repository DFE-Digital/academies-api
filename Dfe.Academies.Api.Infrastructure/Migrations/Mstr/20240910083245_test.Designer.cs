...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dfe.Academies.Domain.Establishment.EducationEstablishmentGovernance", b =>
                {
                    b.Property<long>("SK")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<long?>("EducationEstablishmentId")
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("Forename1")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("Forename1");

                    b.Property<string>("Forename2")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("Forename2");
                    ...
                    b.Property<long?>("GovernanceRoleTypeId")
                        .HasColumnType("bigint")
                        .HasColumnName("FK_GovernanceRoleType");
                    ...
                    b.HasIndex("EducationEstablishmentId");

                    b.HasIndex("GovernanceRoleTypeId");

                    b.ToTable("EducationEstablishmentGovernance", "mstr", t =>
                        {
            ...
            modelBuilder.Entity("Dfe.Academies.Domain.Establishment.GovernanceRoleType", b =>
                {
                    b.Property<long>("SK")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("Ref_GovernanceRoleType", "mstr", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Dfe.Academies.Domain.Establishment.EducationEstablishmentGovernance", b =>
                {
                    b.HasOne("Dfe.Academies.Domain.Establishment.Establishment", "Establishment")
                        .WithMany("EducationEstablishmentGovernances")
                        .HasForeignKey("EducationEstablishmentId");

                    b.HasOne("Dfe.Academies.Domain.Establishment.GovernanceRoleType", "GovernanceRoleType")
                        .WithMany()
                        .HasForeignKey("GovernanceRoleTypeId");

                    b.Navigation("Establishment");

                    b.Navigation("GovernanceRoleType");
                });
            ...
            modelBuilder.Entity("Dfe.Academies.Domain.Establishment.Establishment", b =>
                {
                    b.Navigation("EducationEstablishmentGovernances");
                });
